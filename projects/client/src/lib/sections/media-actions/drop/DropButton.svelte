<script lang="ts">
  ...
  import { attachRemoveWarning } from "$lib/components/buttons/_internal/attachRemoveWarning";
  ...
  const handler = attachRemoveWarning(onDrop, m.drop_show_warning({ title }));
